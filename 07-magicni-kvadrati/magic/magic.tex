...
\emph{\textcolor{purple}{Lo Shu}} -- ">zvitek reke Lo"<. V antični Kitajski je prišlo do
...
\begin{table}[ht]
   ...
   \emph{\textcolor{purple}{Kubera-Kolam}} je talna poslikava, ki se uporablja v Indiji, in je v
...
približno 250 let pred Dürerjevim časom. % sklic: f
...
\end{table}
 ...
 \begin{theorem}
   ...
   števil (glej (1) na strani 2) enaka $1 + 2 + 3 + \dots + n^2 = \sum_{k=1}^{n^2} k = \frac{1}{2} n^2 (n^2 + 1)$. Ker imamo
...
\begin{table}[ht]
   ...
   \caption{Število kvadratov po vrstnem redu}
   \label{table:stevila} 
   \begin{tabular}{lcccccc}
      ...
      \midrule
      red & 1 & 2 & 3 & 4 & 5 & 6 \\
      število kvadratov & 1 & 0 & 1 & 880 & 275305224 & (1,7745 ± 0,0016)1019\\
      \bottomrule
   \end{tabular}
\end{table}
...
\bibitem{berlekamp} E. R. Berlekamp, J. H. Conway, and R. K. Guy, \textit{Games in particular}, in \textit{Winning Ways for Your Mathematical Plays}, vol. 2, Academic Press, London, 1982.

\bibitem{bessy} B. F. de Bessy, \textit{Des quarrez magiques}, De l’imprimerie Royale par Jean Anisson, Paris, 1693.

\bibitem{euler} L. Euler, \textit{De quadratis magicis}, Commentationes arithmeticae, 2 (1849), pp. 593–602.

\bibitem{gardner} M. Gardner, \textit{Mathematical games}, Scientific American, 234 (1976), pp. 118–122.

\bibitem{pinn} K. Pinn and C. Wieczerkowski, \textit{Number of magic squares from parallel tempering monte carlo}, Int. J. Mod. Phys. C, 9 (1998), pp. 541–547.
